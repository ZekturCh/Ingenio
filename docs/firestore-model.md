...
```js
{
  ...
  role: "staff", // admin para el UID autorizado, staff para operadores
  active: true,
...
- `activityLogs` guarda quien inicio sesion, creo pedidos, edito o elimino registros importantes. Solo usuarios con `role: "admin"` deberian leerlo.
